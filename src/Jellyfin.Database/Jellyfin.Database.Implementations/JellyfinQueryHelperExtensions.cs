...
// Note: EF9 supports StringComparison.OrdinalIgnoreCase for Contains/StartsWith/EndsWith
// but not for direct equality comparisons (==), which still require .ToLower()
