...
{
    /// <summary>
    /// The share of the library's studios that may look unused before the cleanup is read as a link
    /// problem instead. A library that genuinely lost this many studios gets them on the next scan.
    /// </summary>
