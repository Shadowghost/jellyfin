...
{
    /// <summary>
    /// The share of the library's genres that may look unused before the cleanup is read as a link
    /// problem instead. A library that genuinely lost this many genres gets them on the next scan.
    /// </summary>
