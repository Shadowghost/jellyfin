...
namespace Rssdp.Infrastructure
{
    ...
    public interface ISsdpCommunicationsServer : IDisposable
    {
        ...
        /// </summary>
        Task SendMulticastMessage(string message, IPAddress fromLocalIpAddress, AddressFamily addressFamily, CancellationToken cancellationToken);
        Task SendMulticastMessage(string message, int sendCount, IPAddress fromLocalIpAddress, AddressFamily addressFamily, CancellationToken cancellationToken);
