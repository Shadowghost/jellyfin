    ...
    public class SubtitleEncoderTests
    {
        ...
        private static string BuildGreekSrt()
        {
            ...
            for (var i = 1; i <= 8; i++)
            {
                ...
                builder.Append("00:00:0").Append(i.ToString(System.Globalization.CultureInfo.InvariantCulture))
                    .Append(",000 --> 00:00:0").Append((i + 1).ToString(System.Globalization.CultureInfo.InvariantCulture)).Append(",000\n");
