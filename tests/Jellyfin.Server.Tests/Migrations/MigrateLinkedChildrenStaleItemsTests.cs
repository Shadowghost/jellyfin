...
public sealed class MigrateLinkedChildrenStaleItemsTests : IDisposable
{
    ...
    [Fact]
    public async Task Perform_NoLibraryLocationsResolved_KeepsEverything()
    {
        var itemId = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa");
        SeedItem(itemId, SeedMediaFile("kept.flac"));

        var deleted = await PerformAsync(libraryLocations: []);

        Assert.Empty(deleted);
    }

    [Fact]
    public async Task Perform_ItemOutsideEveryLocation_IsRemoved()
    {
        ...
        var deleted = await PerformAsync(libraryLocations: [Path.Combine(_root, "media")]);

        Assert.Equal([itemId], deleted);
    }

    [Fact]
    public async Task Perform_ItemInsideLocationWithMissingFile_IsRemoved()
    {
    ...
    [Fact]
    public async Task Perform_ItemInsideLocationWithFilePresent_IsKept()
    {
    ...
    [Fact]
    public async Task Perform_LibraryDefinitionMissing_KeepsItsItems()
    {
    ...
    [Fact]
    public async Task Perform_PathRemovedFromSurvivingLibrary_IsRemoved()
    {
    ...
    private async Task<IReadOnlyList<Guid>> PerformAsync(string[] libraryLocations, string libraryName = "Media")
    {
        ...
        await new MigrateLinkedChildren(
